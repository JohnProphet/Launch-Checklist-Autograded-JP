const { formSubmission, addDestinationInfo } = require("./scriptHelper");
    ...
    window.addEventListener("load", function(event) {   
        ...
        listedPlanetsResponse?.then(function (result) {
            ...
            pickPlanet(planets); //picks a planet from the JSON
            addDestinationInfo(document, name, diameter, star, distance, moons, imageUrl); //adds info from the JSON to the chosen destination
        })
